<?php
    ...
    Class StashUpload
    {
        ...
        {
            //check for the full path first, if it exists, skip the rest of this method
            echo "Looking for: " . $coll . PHP_EOL;
            try {
                $response = $this->client->propFind($this->settings['base_url'] . rawurlencode($coll), array('{DAV:}getcontenttype'), 0);
